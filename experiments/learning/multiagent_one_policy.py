...
if __name__ == "__main__":
    ...
    parser.add_argument('--num_drones',  default=2,        type=int,                                                                                        help=f'Number of drones (default: {NUM_DRONES})', metavar='')
    parser.add_argument('--env',         default='meet_at_height',  type=str,             choices=['meet_at_height', 'figure', 'hover'], help='Help (default: ..)', metavar='')
    ...
    if ARGS.env =='meet_at_height':
        ...
        register_env(temp_env_name, lambda _: HoverAviary(num_drones=ARGS.num_drones,
                                                           aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                                           obs=ARGS.obs,
                                                           act=ARGS.act
                                                           )
    ...
    if ARGS.env == 'meet_at_height':
        ...
        temp_env = HoverAviary(num_drones=ARGS.num_drones,
                                aggregate_phy_steps=shared_constants.AGGR_PHY_STEPS,
                                obs=ARGS.obs,
                                act=ARGS.act
                                )
