...
class Logger(object):
    ...
    def plot(self, pwm=False):
        ...
        colors = ['red', 'blue']  # Add more colors if needed for more drones
        linestyles = ['-', '--']  # Add more styles if needed
        ...
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 0, :], label="drone_"+str(j), color = colors[j], linestyle = linestyles[j])
        axs[row, col].set_xlabel('time (s)')
        axs[row, col].set_ylabel('x (m)')

        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 2, :], label="drone_"+str(j), color = colors[1-j], linestyle = linestyles[1-j])
        axs[row, col].set_xlabel('time (s)')
        ...
        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 7, :], label="drone_"+str(j), color = colors[j], linestyle = linestyles[j])
        axs[row, col].set_xlabel('time (s)')
        ...
        row = 2
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 10, :], label="drone_"+str(j), color = colors[j], linestyle = linestyles[j])
        axs[row, col].set_xlabel('time (s)')
        ...
        row = 0
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 3, :], label="drone_"+str(j), color = colors[j], linestyle = linestyles[j])
        axs[row, col].set_xlabel('time (s)')
        axs[row, col].set_ylabel('vx (m/s)')
        row = 1
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 5, :], label="drone_"+str(j), color = colors[1-j], linestyle = linestyles[1-j])
        axs[row, col].set_xlabel('time (s)')
        ...
        row = 3
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 12, :], label="drone_"+str(j), color = colors[1-j], linestyle = linestyles[1-j])
        axs[row, col].set_xlabel('time (s)')
        axs[row, col].set_ylabel('RPM 0,3')

        col = 1
        row = 3
        for j in range(self.NUM_DRONES):
            axs[row, col].plot(t, self.states[j, 13, :], label="drone_"+str(j), color = colors[1-j], linestyle = linestyles[1-j])
        axs[row, col].set_xlabel('time (s)')
        axs[row, col].set_ylabel('RPM 1,2')
        ...
        fig.legend([f"drone_{i+1}" for i in range(self.NUM_DRONES)], loc="lower center", ncol=self.NUM_DRONES)
